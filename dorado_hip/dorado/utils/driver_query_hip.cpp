...
public:
    ...
    rsmi_status_t SystemGetDriverVersion(char *version, unsigned int length) {
        return m_SystemGetDriverVersion(version, length);
    }

    const char *ErrorString(rsmi_status_t result) { return m_ErrorString(result); }
};
